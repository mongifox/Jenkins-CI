...
public class BookLoansDAO extends BaseDAO<BookLoans> implements ResultSetExtractor<List<BookLoans>>  {
	...
	//2.
	public void updateBookLoanDueDate(Integer bookId, Integer branchId, Integer cardNo, String duedate) throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
